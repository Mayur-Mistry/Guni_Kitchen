...
namespace Guni_Kitchen_WebApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Category_Id,Category_Name,Category_image")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Category_Id,Category_Name,Category_image")] Category category)
        {
